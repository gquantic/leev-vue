...
let apartments: Ref<Apartment[]> = ref<Apartment[]>([]);
        ...
        <div class="col-12">
          <section class="title-sec">
            <div class="d-flex align-items-center justify-content-between">
              ...
              <span class="show-map text-400 d-none d-md-block" data-bs-toggle="modal" data-bs-target="#modal-map"><i
                  class="icon icon-mapPin"></i>Show on map</span>
              <span class="show-map-mobile d-flex align-items-center justify-content-center d-md-none"
                data-bs-toggle="modal" data-bs-target="#modal-map"><i class="icon icon-mapPin"></i></span>
            </div>
          </section>
          <section
            ...
            <div class="sort d-flex align-items-center gap-4">
              ...
              <div class="sort-item sort__price d-flex align-items-center">
                <div class="btn-sort btn-sort-price d-flex align-items-center gap-1">
                  Price<i class="icon icon-chevronDownSmall" style="transform: rotate(0deg)"></i><br />
                </div>
                <div class="sort__price_item" style="opacity: 0; z-index: 0">
                  <div class="filter">
                    <div class="d-flex">
                      <input id="minPrice" min="50" max="2000" class="thumb thumb--left" type="range"
                        value="50" /><input id="maxPrice" min="50" max="2000" class="thumb thumb--right" type="range"
                        value="2000" />
                      <div class="slider">
            ...
            <div id="myBtnContainer" class="btns-sort-cards d-flex align-items-center flex-nowrap gap-2">
              <button class="btn btn-outline-gray active">Show all</button><button
                class="btn btn-outline-gray">Studio</button><button class="btn btn-outline-gray">Lux</button>
              <button class="btn btn-outline-gray">Junior suite</button>
            </div>
          </section>
          <div class="position-relative w-auto m-auto z-3 fs-5"
              ...
              <div :class="item.objectTypes[0]?.name.En + ' show column'" v-for="item in apartments">
                <RouterLink class="list-apartments__item d-block position-relative" :to="'/apartments/' + item.id">
                  <picture>
                    ...
                    <img :src="item.cover" class="apartment-img position-absolute" alt="logo Leev" />
                  </picture>
